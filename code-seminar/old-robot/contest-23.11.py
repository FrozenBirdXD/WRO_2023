...
async def turn(steering: int, degrees: int):
    ...
    await motor_pair.move_for_degrees(
        motor_pair.PAIR_1, degrees, steering, velocity=100
    )
...
def remove_invalid_colors(colors: list):
    ...
    colors_to_remove = [
        ...
        8,
        10,
    ]  # List Comprehension: faster than if statements, since optimized with c and
...
async def main():
    await motor_pair.move_for_degrees(
        motor_pair.PAIR_1, 300, 0, velocity=300
    )  # move to find line
